...
export default async function HomePage() {
  ...
  const [daily, weekCategories] = await Promise.all([
    getDailyTotals(month, { projectName: null, category: null, q: null }),
    getCategoryBreakdown(week, { projectName: null, category: null, q: null }),
  ]);
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div>
        <h2 className="mb-3 text-sm font-medium text-muted-foreground">本周类别</h2>
